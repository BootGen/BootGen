<template>
  <v-container id="privacy-policy" fluid tag="section">
        <v-card>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Code Sharp Kft., 7624 Pecs, Vilmos
                street 23.
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to BootGen, accessible from
                <a
                  href="https://bootgen.com"
          ...
          <ul>
            <li>By email: info@bootgen.com</li>
          </ul>
        </v-card>
  </v-container>
</template>
