        ...
        <base-material-generator-card>
          <template v-slot:heading>
            <div class="display-1 font-weight-light pa-2">
              <span v-if="activeFile && activeFile.name">{{ activeFile.name }}</span>
              <span v-else>Select a file</span>
            </div>
          </template>
          <highlightjs class="d-flex" style="overflow: auto; height:  calc(100% - 21px);" v-if="activeFile && activeFile.content" language='csharp' :code="activeFile.content" />
          <highlightjs class="d-flex" style="overflow: auto; height:  calc(100% - 21px);" v-else language='csharp' code="/* Generated by BootGen https://github.com/BootGen/BootGenVue */" />
        </base-material-generator-card>
      </v-col>
