    ...
    <v-row>
      <v-col cols="12" class="pl-0">
        <base-material-generator-card>
          ...
          <highlightjs class="d-flex" style="overflow: auto; height: calc(100% - 41px);" v-if="activeFile && activeFile.content" language='csharp' :code="activeFile.content" />
          <highlightjs class="d-flex" style="overflow: auto; height: calc(100% - 41px);" v-else language='csharp' code="/* Generated by BootGen https://github.com/BootGen/BootGenVue */" />
        </base-material-generator-card>
      </v-col>
    </v-row>
  </v-container>
